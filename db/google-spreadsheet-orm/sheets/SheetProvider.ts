...
export abstract class SheetProvider {
   ...
   */
  async readData(
    filter?: sheets_v4.Schema$GetSpreadsheetByDataFilterRequest
  ...
  async readFromGrindRange(
    grindRange: sheets_v4.Schema$GridRange,
   ...
   * @param  {string[]} values
   */
  async massCreateCollumnMetadata(
    worksheedId: number,
